...
## 2025-05-22 - Landing Page Modal Consistency
**Learning:** UX patterns established in the main application (like Escape-to-close and backdrop-click) should be consistently applied to the landing/login pages. This prevents "interaction silos" where users' muscle memory fails on certain screens.
**Action:** Audit all secondary pages (Login, Admin, etc.) for modal interaction parity with the primary experience.
