    ...
    init() {
        ...
        window.addEventListener('keydown', (e) => {
            ...
            if (key === 'm') {
                ...
                if (shareBtn && shareBtn.style.display !== 'none') shareBtn.click();
            } else if (key === 'h' || key === '?') {
        ...
        if (lightModeBtn) {
            ...
            const updateLightModeUI = () => {
                ...
                if (isLightMode) {
                    ...
                    lightModeBtn.innerHTML = moonSvg;
                    lightModeBtn.title = "Switch to Dark Mode (L)";
                    lightModeBtn.setAttribute('aria-label', "Switch to Dark Mode (L)");
                } else {
                    lightModeBtn.style.background = '#fff';
                    lightModeBtn.innerHTML = sunSvg;
                    lightModeBtn.title = "Switch to Light Mode (L)";
                    lightModeBtn.setAttribute('aria-label', "Switch to Light Mode (L)");
                }
            };
